...
<?=form_open_multipart('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=teammanager'.AMP.'method=add_player')?>
...
<?=form_submit(array('name' => 'submit', 'value' => lang('add_player'), 'class' => 'submit'))?>
<?=form_close()?>