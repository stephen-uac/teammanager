...
<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=teammanager'.AMP.'method=edit_league'.AMP.'league='.$league_id)?>
...
<?=form_submit(array('name' => 'submit', 'value' => lang('edit_league'), 'class' => 'submit'))?>
<?=form_close()?>